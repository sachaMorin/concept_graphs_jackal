...
params.mapper_localizer.scan_to_map_registration.scan_processing.scan_cropping.cropping_radius_max = 10.0
params.mapper_localizer.scan_to_map_registration.scan_processing.scan_cropping.cropping_radius_min = .3
...
params.map_builder.scan_cropping.cropping_radius_min = 0.3
...
params.dense_map_builder.scan_cropping.cropping_radius_min = 0.3
params.dense_map_builder.space_carving.carve_space_every_n_scans = 10
params.dense_map_builder.space_carving.voxel_size = 0.10
params.dense_map_builder.space_carving.truncation_distance = 0.01
params.dense_map_builder.space_carving.max_raytracing_length = 1.50
